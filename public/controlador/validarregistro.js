  ...
  function validarCorreo(elemento) {
    if (elemento.value.length > 2) {
      ...
      if (pos != -1) {
        ...
        if ((cor == 'est.ups.edu.ec') || (cor == 'ups.edu.ec')||(cor == 'gmail.com')) {
          return true
        } else {
          document.getElementById('mensajeCorreo').innerHTML = '<br>las Direcciones validas son  ups.edu.ec ,est.ups.edu.ec y gmail.com'
